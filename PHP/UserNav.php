    ...
    <div id="onglets">
    <a id="AllEvents" data-active="false" class='nav-link' >All Events</a>
    <a id="YourEvents"  class='nav-link' data-active="true" >Your Events</a>
    <a id="OurContributors"  class='nav-link' data-active="false" >Our Contributors</a>
    <a  id="Contact" class='nav-link' data-active="false" >Contact Us</a>
